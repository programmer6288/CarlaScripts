...
def main():
    ...
    try:
        ...
        vehicle = world.spawn_actor(
            ...
            carla.Transform(carla.Location(x=-295.5, y=30.1575, z=2.12094)))
	...
	f = open('v_data_3.txt', 'w')
		...
		image.save_to_disk('_out/%06d.png' % len(next(os.walk('_out'))[2]))
		f.write(str(vehicle.get_velocity())+'\n')	
